...
const FLOW_AND_PRODUCT: readonly TypeSpec[] = [
  ...
  t({
    ...
    lang: 'diagram',
    engine: 'mermaid',
    // Vega-Lite al final porque es el unico que no necesita nada instalado:
    // si no hay navegador ni Java, el cronograma se dibuja igual.
    fallbacks: ['plantuml', 'vega-lite'],
    aliases: ['cronograma'],
